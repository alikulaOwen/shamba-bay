    ...
    return (
      ...
      <div className="flex bg-green-100 w-full h-full text-gray-900 border justify-center items-center border-green-200">
        <div className="flex mt-8">
          <div className="w-1/2">
            <img
              src={logo}
              alt="user profile"
              className="ml-4 w-20 h-20 rounded-full"
            />
          </div>
        ...
        <div className="mt-10 mb-4">
          <ul className="ml-4">
            <li className="mb-2 px-4 py-4 text-gray-900 flex flex-row  border-gray-300 hover:text-black   hover:bg-green-300 hover:font-bold rounded-lg">
              <span>
                <ViewBoardsIcon className="fill-current h-5 w-5 " />
              </span>
              <a href="#">
            ...
            <li className="mb-2 px-4 py-4 text-gray-900 flex flex-row  border-gray-300 hover:text-black   hover:bg-green-300 hover:font-bold rounded-lg">
              ...
              <a href="#">
                <span className="ml-2">Tasks Tracker</span>
              </a>
            </li>
            <li className="mb-2 px-4 py-4 text-gray-900 flex flex-row  border-gray-300 hover:text-black   hover:bg-green-300 hover:font-bold rounded-lg">
              <span>
